...
*   **Immersive Backgrounds:** The grid and map vanish, replaced by a "Cinematic Background" image that fills the screen (True Widescreen).
*   **Ghost Mode:** While in cinematic mode, tokens can move freely through walls, allowing for dramatic positioning without tactical constraints. tactical walls return instantly when you exit.
*   **Smart Camera:** The view automatically pans and zooms to "Cover" the screen, ensuring no black bars regardless of your monitor size.

### 2. 🎭 Cinematic Portraits
Tokens can swap to a different image when Cinematic Mode is active.
*   **Configuration:** Go to **Token Configuration -> Appearance**.
*   **Cinematic Image:** Set a dedicated high-res bust or portrait.
*   **Visual Novel Feel:** Use top-down tokens for combat and detailed art for roleplay moments.
...
## ⚙️ Compatibility
Fully compatible with and validiated for **Foundry VTT v13**.
